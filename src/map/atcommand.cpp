...
ACMD_FUNC(reload) {
	...
	if (strstr(command, "itemdb") || strncmp(message, "itemdb", 4) == 0) {
		...
		||  prev_config.item_drop_common_min_boss	!= battle_config.item_drop_common_min_boss
		||  prev_config.item_drop_common_min_mvp	!= battle_config.item_drop_common_min_mvp
		||  prev_config.item_drop_common_max		!= battle_config.item_drop_common_max
		||  prev_config.item_drop_common_max_boss   != battle_config.item_drop_common_max_boss
		||  prev_config.item_drop_common_max_mvp	!= battle_config.item_drop_common_max_mvp
		||  prev_config.item_drop_card_min			!= battle_config.item_drop_card_min
		||  prev_config.item_drop_card_min_boss     != battle_config.item_drop_card_min_boss
		||  prev_config.item_drop_card_min_mvp		!= battle_config.item_drop_card_min_mvp
		||  prev_config.item_drop_card_max			!= battle_config.item_drop_card_max
		||  prev_config.item_drop_card_max_boss     != battle_config.item_drop_card_max_boss
		||  prev_config.item_drop_card_max_mvp		!= battle_config.item_drop_card_max_mvp
		...
		||  prev_config.item_drop_equip_min_mvp		!= battle_config.item_drop_equip_min_mvp
		...
		||  prev_config.item_drop_equip_max_mvp		!= battle_config.item_drop_equip_max_mvp
		||  prev_config.item_drop_heal_min			!= battle_config.item_drop_heal_min
		||  prev_config.item_drop_heal_min_boss     != battle_config.item_drop_heal_min_boss
		||  prev_config.item_drop_heal_min_mvp		!= battle_config.item_drop_heal_min_mvp
		||  prev_config.item_drop_heal_max			!= battle_config.item_drop_heal_max
		||  prev_config.item_drop_heal_max_boss     != battle_config.item_drop_heal_max_boss
		||  prev_config.item_drop_heal_max_mvp		!= battle_config.item_drop_heal_max_mvp
		||  prev_config.item_drop_use_min			!= battle_config.item_drop_use_min
		||  prev_config.item_drop_use_min_boss      != battle_config.item_drop_use_min_boss
		||  prev_config.item_drop_use_min_mvp		!= battle_config.item_drop_use_min_mvp
		||  prev_config.item_drop_use_max			!= battle_config.item_drop_use_max
		||  prev_config.item_drop_use_max_boss      != battle_config.item_drop_use_max_boss
		||  prev_config.item_drop_use_max_mvp		!= battle_config.item_drop_use_max_mvp
